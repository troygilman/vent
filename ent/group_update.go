...
func (_u *GroupUpdate) AddPermissionIDs(ids ...int) *GroupUpdate {
...
func (_u *GroupUpdate) RemovePermissionIDs(ids ...int) *GroupUpdate {
...
func (_u *GroupUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.PermissionsCleared() {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: []string{group.PermissionsColumn},
			Bidi:    false,
...
// AddPermissionIDs adds the "permissions" edge to the Permission entity by IDs.
func (_u *GroupUpdateOne) AddPermissionIDs(ids ...int) *GroupUpdateOne {
	_u.mutation.AddPermissionIDs(ids...)
	return _u
}
...
// RemovePermissionIDs removes the "permissions" edge to Permission entities by IDs.
func (_u *GroupUpdateOne) RemovePermissionIDs(ids ...int) *GroupUpdateOne {
	_u.mutation.RemovePermissionIDs(ids...)
	return _u
}
