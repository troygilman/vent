...
func (_u *TagUpdate) AddBookIDs(ids ...int) *TagUpdate {
	_u.mutation.AddBookIDs(ids...)
	return _u
}

// AddBooks adds the "books" edges to the Book entity.
func (_u *TagUpdate) AddBooks(v ...*Book) *TagUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddBookIDs adds the "books" edge to the Book entity by IDs.
func (_u *TagUpdateOne) AddBookIDs(ids ...int) *TagUpdateOne {
	_u.mutation.AddBookIDs(ids...)
	return _u
}

// AddBooks adds the "books" edges to the Book entity.
func (_u *TagUpdateOne) AddBooks(v ...*Book) *TagUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearBooks clears all "books" edges to the Book entity.
func (_u *TagUpdateOne) ClearBooks() *TagUpdateOne {
	_u.mutation.ClearBooks()
	return _u
}

// RemoveBookIDs removes the "books" edge to Book entities by IDs.
func (_u *TagUpdateOne) RemoveBookIDs(ids ...int) *TagUpdateOne {
	_u.mutation.RemoveBookIDs(ids...)
	return _u
}

// RemoveBooks removes "books" edges to Book entities.
func (_u *TagUpdateOne) RemoveBooks(v ...*Book) *TagUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
