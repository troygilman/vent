...
const (
	...
	PermissionsTable = "permission_group_permissions"
...
var (
	...
	PermissionsPrimaryKey = []string{"permission_group_id", "permission_id"}
	// UsersPrimaryKey and UsersColumn2 are the table columns denoting the
	// primary key for the users relation (M2M).
	UsersPrimaryKey = []string{"user_id", "permission_group_id"}
)
