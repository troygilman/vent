...
var xe = [],
    ...
    J = (e, t) => {
        if (
            (e !== void 0 && t !== void 0 && xe.push([e, t]), !Oe && xe.length)
        ) {
            let n = Me(xe);
            ((xe.length = 0),
    ...
    O = (e, { ifMissing: t } = {}) => {
        M();
        for (let n in e)
            e[n] == null ? t || delete X[n] : vt(e[n], n, X, "", t);
        x();
    },
    T = (e, t) => O(Me(e), t),
    vt = (e, t, n, r, s) => {
            ...
            try {
                ...
                let Ae = Object.assign({}, V, l),
                    re = {
                        ...
                        onopen: async (g) => {
                            g.status >= 400 &&
                                ee(sn, r, { status: g.status.toString() });
                        },
                        onmessage: (g) => {
...
`),
                        ...
                        onerror: (g) => {
                            if (Lt(g))
                                throw g("FetchExpectedTextEventStream", {
                                    url: a,
                                });
                            g &&
                                (console.error(g.message),
                                ee(on, r, { message: g.message }));
                        },
                    },
                ...
                if (u === "json") {
                    (F(),
                        (m = m !== void 0 ? m : _({ include: d, exclude: h })),
                        P());
                    ...
                    throw o("FetchInvalidContentType", {
                        action: k,
                        contentType: u,
                    });
                ...
                g = async () => {
                    ...
                    try {
                        ...
                        if (Ve?.includes("text/javascript")) {
                            ...
                            if (me)
                                for (let [$e, Re] of Object.entries(
                                    JSON.parse(me),
                                ))
                                    $.setAttribute($e, Re);
            ...
            switch (e.type) {
                ...
                case "checkbox":
                    ((i = (f, m) =>
                        ...
                        (a = (f) => {
                            e.checked =
                                typeof f == "string" ? f === e.value : f;
                        }));
                    break;
                case "radio":
                    (e.getAttribute("name")?.length ||
                        e.setAttribute("name", o),
                        (i = (f, m) =>
                            f.checked
                                ? m === "number"
                                    ? +f.value
                        ...
                        (a = (f) => {
                            e.checked =
                                f ===
                                (typeof f == "number" ? +e.value : e.value);
                        }));
                    break;
                case "file": {
                    let f = () => {
        ...
        let s,
            o = () => {
                ...
                for (let c in s) {
                    ...
                    if (s[c])
                        for (let u of l)
                            t.classList.contains(u) || t.classList.add(u);
                    else
                        for (let u of l)
    ...
    apply({ el: e, mods: t, rx: n }) {
        ...
        let o = t.has("exit"),
            i = new IntersectionObserver((a) => {
                for (let c of a)
                    c.isIntersecting !== o &&
                        (r(), i && nt.has(e) && i.disconnect());
            }, s);
        return (
            i.observe(e),
            t.has("once") && nt.add(e),
            () => {
                (t.has("once") || nt.delete(e),
    ...
    apply({ key: e, el: t, rx: n }) {
        let { style: r } = t,
            ...
            o = (l, u) => {
                ...
                !u && u !== 0
                    ? d !== void 0 &&
                      (d ? r.setProperty(l, d) : r.removeProperty(l))
            ...
            i = () => {
                if ((a.disconnect(), e)) o(e, n());
                    ...
                    for (let [u, d] of s)
                        u in l ||
                            (d ? r.setProperty(u, d) : r.removeProperty(u));
...
var jt = (e) => {
        ...
        for (let n of t)
            if (!st.has(n)) {
                ...
                for (let { name: s, value: o } of n.attributes)
                    r.setAttribute(s, o);
    ...
    rt = (e, t) => {
        ...
        if (n === 1) {
            ...
            (o &&
                ...
                o &&
                    r.dispatchEvent(
                        new CustomEvent("datastar:scope-children", {
                            bubbles: !1,
                        }),
                    ));
        }
